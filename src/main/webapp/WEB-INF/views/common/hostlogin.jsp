...
<body>
	...
	<form name="joinon" method="post" action="hostmain"
		onsubmit="return joinCheck();">
	<input type="hidden" name="hiddenid" value="0">
	<table align="center">
			<tr>
				<th colspan="2">관리자 로그인 정보를 입력하세요</th>
			</tr>
			<tr>
				<th> * 아이디</th>
			...
			<tr>
				<th colspan="2">
					...
					<input class="inputButton" type="button" value="게스트로그인" onclick="window.location='login'">
				</th>
			</tr>		
		</table>
	</form>
